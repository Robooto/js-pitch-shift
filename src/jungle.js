...
function Jungle(context) {
    ...
    this.shiftDownBuffer = this.createDelayTimeBuffer(context, this.bufferTime, this.fadeTime, false);
    this.shiftUpBuffer = this.createDelayTimeBuffer(context, this.bufferTime, this.fadeTime, true);
    ...
    var fadeBuffer = this.createFadeBuffer(context, this.bufferTime, this.fadeTime);
...
Jungle.prototype.createDelayTimeBuffer = function(context, activeTime, fadeTime, shiftUp) {
...
Jungle.prototype.createFadeBuffer = function(context, activeTime, fadeTime) {
    var length1 = activeTime * context.sampleRate;
    var length2 = (activeTime - 2*fadeTime) * context.sampleRate;
    var length = length1 + length2;
    var buffer = context.createBuffer(1, length, context.sampleRate);
